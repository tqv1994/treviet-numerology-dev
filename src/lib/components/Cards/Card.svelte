...
<style>
  .bg-candy {
	...
	.bg-traffic{
		background-image: linear-gradient(to right, #172B4D , #1A174D);
    color:white;
    border-radius: 0.375rem;
	}
  .bg-revenue{
    background-image: linear-gradient(to right, #5E72E4 , #825EE4);
    color:white;
    border-radius: 0.375rem;
  }
  .bg-revenue-agent{
    background-image: linear-gradient(to right, #FB6340 , #FBB140);
    color:white;
    border-radius: 0.375rem;
  }
  .bg-sum-agent{
    background-image: linear-gradient(to right, #2DCE89 , #2DCECC);
    color:white;
    border-radius: 0.375rem;
  }
</style>
