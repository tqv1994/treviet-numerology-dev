<script>
	...
	export let logo = '../../img/theme/logo.png';
	...
	function ValidateBackground(bgColor) {
		let acceptedValues = ['', 'blue', 'green', 'orange', 'red', 'primary'];

		if (acceptedValues.indexOf(bgColor) !== -1) {
			return bgColor;
		} else {
			return null;
		}
...
>
	<div class="scrollbar-inner" ref="sidebarScrollArea" style="background-color: #333333;">
